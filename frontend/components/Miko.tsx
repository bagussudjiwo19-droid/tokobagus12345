...
const KIOSK_SAY: string[] = [
  ...
  // Pengingat lembut kebutuhan rumah / dapur (acak, tidak mengganggu)
  "Kak, sudah cek kebutuhan pokok di rumah? Siapa tahu ada yang mulai habis.",
  "Coba ingat-ingat stok beras, minyak, gula, dan kebutuhan dapur ya, Kak.",
  "Mungkin ada camilan di rumah yang sudah mulai habis? 😄",
  "Kak, kalau di rumah suka ngemil, jangan lupa cek stok camilannya.",
  "Mau membuat kue di rumah? Coba ingat-ingat tepung, gula, telur, dan bahan lainnya.",
  "Kak, siapa tahu ada rencana bikin kue. Bahan-bahannya sudah lengkap belum?",
  "Kalau mau bikin gorengan, jangan lupa cek tepung dan bahan pelengkapnya ya, Kak.",
  "Miko mengingatkan sedikit... stok minyak goreng di rumah masih ada?",
  "Kak, coba cek bumbu dapur juga. Siapa tahu ada yang hampir habis.",
  "Mau masak hari ini? Mungkin ada bahan masakan yang belum dibeli.",
  "Kalau ada rencana bikin gorengan sore nanti, bahan-bahannya sudah siap belum? 😊",
  "Mungkin ada kebutuhan untuk sarapan besok yang perlu disiapkan, Kak.",
  "Kak, jangan lupa cek stok mie, kopi, teh, dan camilan di rumah.",
  "Kalau di rumah ada anak-anak, coba ingat stok camilannya juga ya.",
  "Mau bikin kue akhir pekan ini? Mungkin bahan-bahannya bisa disiapkan dari sekarang.",
  "Kak, sebelum pulang coba cek lagi kebutuhan dapur. Jangan sampai ada yang terlupa.",
  "Siapa tahu ada stok gula atau tepung yang sudah tinggal sedikit.",
  "Kalau suka bikin gorengan, coba ingat stok tepung, minyak, dan bumbunya.",
  "Miko takut nanti sampai rumah baru ingat, 'Wah, lupa beli bahan kue!' 😂",
  "Kak, sudah lengkap untuk kebutuhan dapur minggu ini?",
  "Mungkin ada kebutuhan pokok yang perlu ditambah untuk persediaan di rumah.",
  "Coba ingat stok makanan ringan, siapa tahu ada yang ingin ngemil nanti. 😋",
  "Kalau mau masak atau membuat olahan, mungkin ada bahan yang belum masuk keranjang.",
  "Miko bantu mengingatkan: kebutuhan dapur, camilan, dan bahan masakan sudah dicek?",
  "Sebelum pulang, coba ingat-ingat lagi. Ada bahan kue atau gorengan yang tertinggal?",
  "Kalau ada rencana memasak besok, lebih enak bahan-bahannya sudah disiapkan dari sekarang.",
  "Kak, kebutuhan rumah bukan cuma yang besar-besar. Bumbu kecil juga sering lupa. 😄",
  "Jangan lupa cek stok kebutuhan sehari-hari sebelum pulang ya, Kak.",
  "Kalau sedang belanja bulanan, mungkin sekalian cek kebutuhan pokok yang hampir habis.",
  "Semoga semua kebutuhan rumah, camilan, dan bahan masakan sudah lengkap hari ini. 💚",
];
