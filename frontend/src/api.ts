...
export type OcrKey = "amount" | "sender_name" | "sender_bank" | "sender_account" | "recipient" | "recipient_username" | "method" | "ref" | "txno" | "product" | "date" | "time" | "customer_name" | "customer_id" | "token" | "phone" | "operator";
export type OcrBuktiResult = { fields: Record<OcrKey, OcrField> };
...
export const api = {
  ...
  saveBukti: (b: Partial<Bukti> & { id?: string; created_at?: string }): Promise<Bukti> =>
    local.saveBukti(b),
